...
namespace ce205_hw4_gui
{
    public partial class Form1 : Form
    {
        ...
        private void SmithAlignment_Click_1(object sender, EventArgs e)
        {

        }

        private void SmithAlignment_Click_2(object sender, EventArgs e)
        {
        ...
        private void SmithAlignment_Click_3(object sender, EventArgs e)
        {
            smith_waterman smith = new smith_waterman();
            string gene1 = SmithtextBox1.Text;
            string gene2 = SmithtextBox2.Text;
        ...
        private void SearchKnuth_Click_1(object sender, EventArgs e)
        {
            ...
            foreach (string word in words)
            {
                ...
                while (startIndex < KnuthrichTextBox.TextLength)
                {
                    ...
                    if (index != -1)
                    {
                        ...
                        KnuthrichTextBox.SelectionColor = Color.Green;
                    }
                    else
                        break;
        ...
        private void SearchHorspool_Click(object sender, EventArgs e)
        {
            ...
            foreach (string word in words)
            {
                ...
                {
                    int index = horspool.ShiftMyTable(word, HorspoolrichTextBox.Text, startIndex);
                    if (index != -1)
                    {
                        HorspoolrichTextBox.SelectionStart = index;
                        HorspoolrichTextBox.SelectionLength = word.Length;
                        HorspoolrichTextBox.SelectionColor = Color.Green;
                    }
                    else
                        break;
                    startIndex += index + word.Length;
            ...
            foreach (string word in words)
            {
                ...
                while (startIndex < BoyerrichTextBox.TextLength)
                {
                    ...
                    if (index != -1)
                    {
                        ...
                        BoyerrichTextBox.SelectionColor = Color.Green;
                    }
                    else
                        break;
                    startIndex += index + word.Length;
        ...
        private void InsertTrie_Click(object sender, EventArgs e)
        {
            ...
            trie_algorithm.Trie root = new trie_algorithm.Trie();
            ...
            for (i = 0; i < keys.Length; i++)
            {
                ...
                trie_algorithm.Trie.Insert(keys[i]);
            }
        }
        ...
        private void HuntrichTextBox_TextChanged(object sender, EventArgs e)
        {
